...
$projectPath = 'C:\Users\maaku\Documents\Codex\one-minute-tools'
$promptPath = Join-Path $projectPath 'automation\daily-site-operation.prompt.md'
$logDirectory = 'C:\Users\maaku\.codex\site-automation-logs\one-minute-tools'
...
try {
  ...
  if ($SmokeTest) {
    $prompt = '[OneMinuteTools smoke test] Do not inspect or modify files. Reply with exactly: AUTOMATION_TEST_OK'
  }
  else {
